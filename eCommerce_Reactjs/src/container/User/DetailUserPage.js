                ...
                <div className="col-md-9 border-right">
                    <div className="p-3 py-5">
                        ...
                        <div className="row mt-2">
                            <div className="col-md-6"><label className="labels">Frirst Name</label><input name="firstName" onChange={(event) => handleOnChange(event)} value={inputValues.firstName} type="text" className="form-control" /></div>
                            <div className="col-md-6"><label className="labels">Last Name</label><input name="lastName" onChange={(event) => handleOnChange(event)} value={inputValues.lastName} type="text" className="form-control" /></div>
                        </div>
                        ...
                        <div className="row mt-2">
                            <div className="col-md-3">
                                <label className="labels">Select photo</label>
