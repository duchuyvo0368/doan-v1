                            ...
                            return (
                                <div key={index}>
                                    <div className='box-list-order'>
                                        <div className='content-top'>
                                            <div className='content-left'>
                                                ...
                                                <span className='label-name-shop'>Fashion shop</span>
                                            ...
                                            <div className='content-right'>
                                                {item.statusOrderData && item.statusOrderData.value} {item.isPaymentOnline == 1 && ' | Paid'}
                                            </div>
                                        </div>
                                                    ...
                                                    <div className='content-center'>
                                                        <div className='box-item-order'>
                                                            ...
                                                            <div className='box-des'>
                                                                ...
                                                                <span className='type'>Classification of goods: {item.productDetail.nameDetail} | {item.productDetailSize.sizeData.value}</span>
                                    ...
                                    <div className='content-bottom'>
                                        ...
                                        <div className='down'>
                                            {((item.statusId == 'S3') || (item.statusId == 'S4')) && item.isPaymentOnline == 0 &&
